...
// adding the buttons for hungry, thirsty, or both
function introButtons() {
    let introButtonDiv = 
    '<div class="card border-secondary text-center"> \
        <h5>How can we help you?</h5> \
        <div class="card-body"> \
            <button id="hungrybutton" type="button" class="btn btn-success text-center m-1"><i class="fas fa-utensils"></i> I am hungry!</button> \
            <button id="thirstybutton" type="button" class="btn btn-warning text-center m-1"><i class="fas fa-beer"></i> I am thirsty!</button> \
            <button id="bothbutton" type="button" class="btn btn-info text-center m-1"><i class="fas fa-utensils"></i> I am both!! <i class="fas fa-beer"></i></button> \
        </div> \
    </div>'
